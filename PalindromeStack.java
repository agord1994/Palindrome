...
public class PalindromeStack {
	...
	Stack palStack= new Stack();//instantiating new stacke
	String reverse="";//declaring reverse string variable
		
	//iterates thrugh loop pushing characters to stack
	for(int i=0;i<userInput.length();i++) {
		...
		//compares reverse stack with intial stack, if the stacks are the 
